...
function Features(){
  return(
    ...
    <section className="py-12 bg-white text-center">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-8">
       {features.map((feature,index) =>(
           <div key={index} className="border p-6 rounded-lg  hover:shadow-xl transition">
    ...
    <section className="py-12 bg-gray-100">
     <h2 className="text-3xl mb-8 font-bold text-center text-green-700">Upcoming Matches </h2>
       <div className="max-w-2xl mx-auto space-y-4">
       {matches.map((match,index)=> (
        <div key={index} className="bg-white shadow p-4 rounded-md flex justify-between items-center">
